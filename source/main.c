...
// 	// Build the UI.
// 	surface_frame_begin(surface, 0, 0, surface->size.x, surface->size.y, CENTER_X, CENTER_Y);
// 		surface_row_begin(surface, 0.5);
// 			button_id button = surface_button_add(surface, "press me");
// 			surface_label_add(surface, "hello");
// 		surface_row_end(surface);
// 	surface_frame_end(surface);

// 	// Main event and drawing loop.
// 	while (window_is_open(window)) {
// 		surface_draw_ui(surface);
// 		window_update(window);
// 		if (button_is_pressed(surface, button_id)) {
// 			// Do something.
// 		}
// 	}
